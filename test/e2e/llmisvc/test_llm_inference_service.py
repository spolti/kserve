...
class TestCase:
    ...
    # Factory provided
    llm_service: V1alpha1LLMInferenceService = None  # Generated by fixture
    model_name: str = "default/model"  # This will be generated by the fixture
    ...
    [
        pytest.param(
            TestCase(
                ...
                before_test=[
                    lambda: create_router_resources(gateways=[ROUTER_GATEWAYS[0]]),
                ],
            ),
            marks=[
...
def test_llm_inference_service(test_case: TestCase):
    ...
    # Disable auth for general inference tests (auth is tested separately in test_llm_auth.py)
