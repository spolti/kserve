...
```console
$ helm install kserve oci://ghcr.io/kserve/charts/kserve --version v0.14.1-rc1
```
...
| kserve.agent.tag | string | `"v0.14.1-rc1"` |  |
...
| kserve.controller.tag | string | `"v0.14.1-rc1"` | KServe controller contrainer image tag. |
...
| kserve.localmodel.controller.tag | string | `"v0.14.1-rc1"` |  |
...
| kserve.router.tag | string | `"v0.14.1-rc1"` |  |
| kserve.security.autoMountServiceAccountToken | bool | `true` |  |
| kserve.servingruntime.art.defaultVersion | string | `"v0.14.1-rc1"` |  |
...
| kserve.servingruntime.huggingfaceserver.tag | string | `"v0.14.1-rc1"` |  |
...
| kserve.servingruntime.lgbserver.tag | string | `"v0.14.1-rc1"` |  |
...
| kserve.servingruntime.paddleserver.tag | string | `"v0.14.1-rc1"` |  |
...
| kserve.servingruntime.pmmlserver.tag | string | `"v0.14.1-rc1"` |  |
...
| kserve.servingruntime.sklearnserver.tag | string | `"v0.14.1-rc1"` |  |
...
| kserve.servingruntime.xgbserver.tag | string | `"v0.14.1-rc1"` |  |
...
| kserve.storage.tag | string | `"v0.14.1-rc1"` |  |
| kserve.version | string | `"v0.14.1-rc1"` |  |
