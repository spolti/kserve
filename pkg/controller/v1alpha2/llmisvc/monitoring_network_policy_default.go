...
// cleanupMonitoringNetworkPolicy is a no-op in upstream builds.
func (r *LLMISVCReconciler) cleanupMonitoringNetworkPolicy(_ context.Context, _ *v1alpha2.LLMInferenceService) error {
	return nil
}
