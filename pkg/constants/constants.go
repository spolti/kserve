...
const (
	...
	// ODHAuthProxyTypeAnnotation is the annotation key to select auth proxy type
	ODHAuthProxyTypeAnnotation = "security.opendatahub.io/auth-proxy-type"
	// OauthProxyType selects the oauth-proxy sidecar (default)
	OauthProxyType OauthProxyProvider = "oauth-proxy"
	// KubeRbacProxyType selects the oauth-proxy sidecar (default)
	KubeRbacProxyType OauthProxyProvider = "kube-rbac-proxy"
	// KubeRbacProxyImage  Used for test purposes
	KubeRbacProxyImage = "quay.io/opendatahub/odh-kube-auth-proxy@sha256:dcb09fbabd8811f0956ef612a0c9ddd5236804b9bd6548a0647d2b531c9d01b3"
)

type OauthProxyProvider string
