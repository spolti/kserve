...
RUN cd storage && poetry install --no-root --no-interaction --no-cache --extras "storage"
COPY storage storage
RUN cd storage && poetry install --no-interaction --no-cache --extras "storage" --extras "logging"
